.function: main/0
  ...
  frame ^[(param %0 %2 local)]
  call %1 local log/1
  echo (strstore %4 local "log 7.6 = 2.02814825 : ")
  print %1 local
  izero %0 local
  return
.end
...
.function: exp/1
  ...
  fstore %3 local 1
  istore %4 local 1
  fstore %7 local 0.00000000000000000000000000000001
  frame ^[(param %0 %2 local)]
  call %8 local abs/1
  .mark: exp_loop
  div %5 local %2 local %3 local
  div %9 local %8 local %3 local
  add %0 local %0 local %5 local
  mul %2 local %2 local %1 local
  iinc %4 local
  mul %3 local %3 local %4 local
  if (gte %6 local %9 local %7 local) exp_loop
  return
.end
